...
router.get(
  '/admin/announcements',
  announcementsController.listAnnouncements.bind(announcementsController)
);
router.post(
  '/admin/announcements',
...
router.get(
  ...
  announcementsController.getAnnouncement.bind(announcementsController)
);
router.put(
  '/admin/announcements/:id',
...
router.get(
  ...
  announcementsController.getActiveAnnouncements.bind(announcementsController)
);
