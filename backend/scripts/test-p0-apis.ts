 ...
 */
async function testAIChatAPI(config: TestConfig): Promise<TestResult> {
 ...
 */
async function testCOSSTSAPI(config: TestConfig): Promise<TestResult> {
  const result: TestResult = {
 ...
 */
async function testKBDocumentAPI(config: TestConfig): Promise<TestResult> {
  const result: TestResult = {
